...
var _class = function (_Component) {
  ...
  function _class() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class.__proto__ || Object.getPrototypeOf(_class)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      m: _this.props.moment.clone()
    }, _this.changeHours = function (pos) {
      var m = _this.props.moment;
      var _m = _this.props._moment;
      m.hours(pos.x);
      _m.hours(pos.x);
      _this.props.onChange(m.clone());
    }, _this.changeMinutes = function (pos) {
      var minStep = _this.props.minStep;

      var m = _this.props.moment;
      var _m = _this.props._moment;
      var x = Math.floor(pos.x / minStep) * minStep;
      m.minutes(x);
      _m.minutes(x);
      _this.props.onChange(m.clone());
  ...
  _createClass(_class, [{
    ...
    value: function render() {
      ...
      var _props$text = this.props.text,
          hours = _props$text.hours,
          minutes = _props$text.minutes;
