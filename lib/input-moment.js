...
var InputMoment = function (_Component) {
  ...
  function InputMoment() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = InputMoment.__proto__ || Object.getPrototypeOf(InputMoment)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      tab: 0,
      _moment: _this.props.moment.clone()
    }, _this.handleClickTab = function (e, tab) {
      e.preventDefault();
      _this.setState({ tab: tab });
    }, _this.handleSave = function (e) {
      e.preventDefault();
      if (_this.state.tab === 0) {
        _this.setState({ tab: 1 });
        return;
      }
      _this.props.onChange(_this.props.moment.clone());
      if (_this.props.onSave) _this.props.onSave();
    }, _this.handleChange = function (_moment) {
      _this.setState({ _moment: _moment.clone() });
  ...
  _createClass(InputMoment, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          dateIcon = _props.dateIcon,
          timeIcon = _props.timeIcon,
          minStep = _props.minStep,
          hourStep = _props.hourStep,
          onSave = _props.onSave,
          customText = _props.customText,
          onValidate = _props.onValidate,
          isRtl = _props.isRtl,
          props = _objectWithoutProperties(_props, ['moment', 'className', 'prevMonthIcon', 'nextMonthIcon', 'dateIcon', 'timeIcon', 'minStep', 'hourStep', 'onSave', 'customText', 'onValidate', 'isRtl']);

      var cls = (0, _classnames2.default)('m-input-moment', className);
      var today = (0, _moment3.default)().date();
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            {
              type: 'button',
              className: (0, _classnames2.default)({ 'is-active': tab === 0 }),
              onClick: function onClick(e) {
                return _this2.handleClickTab(e, 0);
              }
            },
            _react2.default.createElement('i', { className: dateIcon }),
            text.date
          ),
          _react2.default.createElement(
            'button',
            {
              type: 'button',
              className: (0, _classnames2.default)({ 'is-active': tab === 1 }),
              onClick: function onClick(e) {
...
InputMoment.defaultProps = {
  ...
  timeIcon: 'ion-clock',
  onValidate: function onValidate(m) {
    return true;
  },
  customText: {},
  minStep: 1,
